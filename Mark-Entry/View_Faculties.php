...
<table width="755">
	<tr>
        ...
        <td>
        	<a href="everystu.php?tag=faculties_entry"><input type="button" title="Add new student" name="butAdd" value="Add New" id="button-search" /></a>
        </td>
        <td>
...
<form method="post">
	...
	if(isset($_POST['searchtxt']))
		...
		if($key !="")
			$sql_sel=mysql_query("SElECT * FROM facuties_tbl WHERE faculties_id  like '%$key%' or faculties_sname like '%$key%'");
			else
