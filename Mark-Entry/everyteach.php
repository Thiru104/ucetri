...
<div id="admin">
        ...
        <div id="lmain">
                ...
                <div id="leftmanu">
                 ...
                 <div>
                    	<a href="everyteach.php?tag=student_entry" title="Shift+1"> &nbsp;Students Entry </a><br />
                    </div>
                    
                    <div>
                    	<a href="everyteach.php?tag=teachers_entry" class="customer" title="Shift+2">&nbsp;Teachers Entry</a>
                    </div>
                    
                     <div>
                    	<a href="everyteach.php?tag=faculties_entry" class="customer" title="Shift+3">&nbsp;Faculties Entry</a>
                    </div>
                    
                     <div>
                    	<a href="everyteach.php?tag=subject_entry" class="customer" title="Shift+4">&nbsp;Subjects Entry</a>
                    </div>
                    
                     <div>
                    	<a href="everyteach.php?tag=score_entry" class="customer" title="Shift+5">&nbsp;Scores Entry</a>
                    </div>
                    
                    <div>
                    	<a href="everyteach.php?tag=test_score" class="customer" title="Shift+Ctrl+T">&nbsp;Test Score</a>
                    </div>
                    
                   <div>
                    	<a href="everyteach.php?tag=contact" class="customer" title="Shift+Ctrl+C">&nbsp;Contact </a>
                    </div>
    	...
    	<div id="pic_manu">
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="">Students</a>
                    ...
                    <ul>
                        <li id="li_submenu">
                        <a href="everyteach.php?tag=student_entry" class="sales">Students Entry</a></li>
                        <li id="li_submenu"><a href="everyteach.php?tag=view_students" class="stocks">View Students</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Teachers</a>
                    ...
                    <ul>
                        <li id="li_submenu">
                        <a href="everyteach.php?tag=teachers_entry" class="order">Teachers Entry</a></li>
                        <li id="li_submenu"><a href="everyteach.php?tag=view_teachers" class="stocks">View Teachers</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="">Facuties</a>
                    ...
                    <ul>
                        <li id="li_submenu"><a href="everyteach.php?tag=faculties_entry" class=" order">Facuties Entry</a></li>
                        <li id="li_submenu"><a href="everyteach.php?tag=view_faculties" class="customer">View Facuties</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Subjects</a>
                    ...
                    <ul>
                    	<li id="li_submenu"><a href="everyteach.php?tag=subject_entry" class=" customer">Subjects Entry</a></li>
                        <li id="li_submenu"><a href="everyteach.php?tag=view_subjects" class=" customer">View Subjects</a></li>
                    </ul>
           ...
           <li id="li_menu"><a href="">Score</a>
                    ...
                    <ul>
                        ...
                        <li id="li_submenu"><a href="everyteach.php?tag=score_entry" class="customer"> Score Entry</a></li>
                        <li id="li_submenu"><a href="everyteach.php?tag=view_scores" class="order">View Score</a></li>
                    </ul>
